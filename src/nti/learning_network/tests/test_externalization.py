...
class TestExternalization(LearningNetworkTestCase):
    ...
    def test_social_stats(self):
        ...
        assert_that(ext_obj, has_entry(
            'Class', SocialStats.__external_class_name__))
        ...
        assert_that(ext_obj, 
					has_entry('DistinctUserReplyToOthersCount', user_reply_count))
    ...
    def test_connection(self):
        ...
        assert_that(ext_obj, 
					has_entry('Class', Connection.__external_class_name__))
